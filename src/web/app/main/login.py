...
def logout():
    ...
    return redirect('https://eu-north-1ocupftfb2.auth.eu-north-1.amazoncognito.com/logout?client_id=14nn8j8mt9n5vc8dir9jqb6n77&logout_uri=https://ledger.zekibalci.com')